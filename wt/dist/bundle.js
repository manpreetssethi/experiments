...
var AppBox = function (_React$Component) {
	_inherits(AppBox, _React$Component);

	function AppBox() {
		_classCallCheck(this, AppBox);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(AppBox).apply(this, arguments));
	}
...
exports.default = AppBox;

},{"./components/UploadForm":38,"react":32}],34:[function(require,module,exports){
'use strict';

var _AppBox = require('./AppBox');
...
$(document).ready(function () {
	// Render the App
	ReactDOM.render(React.createElement(_AppBox2.default, null), document.getElementById('app'));
});

},{"./AppBox":33}],35:[function(require,module,exports){
'use strict';
...
var _CustomCanvas = require('./CustomCanvas');

var _CustomCanvas2 = _interopRequireDefault(_CustomCanvas);
...
var ArcLoader = function (_React$Component) {
	_inherits(ArcLoader, _React$Component);

	function ArcLoader() {
		_classCallCheck(this, ArcLoader);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(ArcLoader).apply(this, arguments));
	}

	_createClass(ArcLoader, [{
		key: 'render',
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-lg-12' },
						_react2.default.createElement(_CustomCanvas2.default, { width: this.props.width, height: this.props.height, arcSpecs: this.props.specs })
					)
				),
				_react2.default.createElement(
					'div',
					{ className: 'al-progress-label al-label' },
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'al-completed-label al-label' },
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement(
...
exports.default = ArcLoader;

},{"./CustomCanvas":36,"react":32}],36:[function(require,module,exports){
'use strict';
...
var CustomCanvas = function (_React$Component) {
	_inherits(CustomCanvas, _React$Component);

	function CustomCanvas() {
		_classCallCheck(this, CustomCanvas);

		return _possibleConstructorReturn(this, Object.getPrototypeOf(CustomCanvas).apply(this, arguments));
	}

	_createClass(CustomCanvas, [{
		...
		key: 'paintArc',
		value: function paintArc(context, specs) {
			// Arc
			context.beginPath();
			context.arc(specs.x, specs.y, specs.radius, specs.startAngle, specs.endAngle, specs.counterClockwise);
		...
		value: function render() {
			...
			return _react2.default.createElement('canvas', { width: this.props.width, height: this.props.height, ref: function ref(c) {
...
},{"react":32}],37:[function(require,module,exports){
'use strict';
...
},{"react":32}],38:[function(require,module,exports){
'use strict';
...
var _ArcLoader = require('./ArcLoader');

var _ArcLoader2 = _interopRequireDefault(_ArcLoader);
...
var UploadForm = function (_React$Component) {
	...
	function UploadForm(props) {
		...
		_this.completeUpload = _this.completeUpload.bind(_this);
		return _this;
	}
	...
	_createClass(UploadForm, [{
		...
		key: 'completeUpload',
		value: function completeUpload(filename) {
			this.setState({
				completed: true,
				uploading: false
			});
		...
		key: 'showError',
		value: function showError(filename) {}
	}, {
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-lg-12' },
						_react2.default.createElement(_ArcLoader2.default, {
